...
//TCDelfile -exclui tabela no servidor, lembrar de colocar RetSqlName("SA1") para pegar da empresa correta
	if empty(cUserTable)
		TCDelfile("CHECKTOP")
	Endif
...
//TcSqlExec -executa comandos no mssql (TERROR DE ANALISTA RUIM)
